  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="荣誉级别" prop="honorLevel">
        <el-input
          v-model="queryParams.honorLevel"
          placeholder="请输入荣誉级别"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:alumni_honor:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:alumni_honor:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:alumni_honor:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:alumni_honor:export']"
        >导出</el-button>
      </el-col>
       ...
       <el-table-column label="荣誉附件" align="center" prop="honorAttach" >
         <template slot-scope="scope">
          ...
          <div class="table-image-wrapper">
            <img
              v-for="(imgUrl, idx) in parsePicture(scope.row.honorAttach)"
              :key="idx"
              :src="imgUrl"
            ...
            />
            <!-- 空图片提示 -->
            <span v-if="!scope.row.honorAttach || parsePicture(scope.row.honorAttach).length === 0" class="empty-image-tip">
              暂无图片
            </span>
          </div>
        </template>
