...
export default {
  ...
  data() {
    return {
      statList: [
        { label: '录取人数', value: '604', bg: 'linear-gradient(135deg,#667eea 0%,#764ba2 100%)', icon: 'el-icon-user-solid' },
        { label: '报名人数', value: '1,259', bg: 'linear-gradient(135deg,#FF9A9E 0%,#FAD0C4 100%)', icon: 'el-icon-edit' },
        { label: '服务地区', value: '20', bg: 'linear-gradient(135deg,#FFECD2 0%,#FCB69F 100%)', icon: 'el-icon-position' },
        { label: '活跃人数', value: '123', bg: 'linear-gradient(135deg,#84FAB0 0%,#8FD3F4 100%)', icon: 'el-icon-chat-dot-round' }
      ],
      funcList: [
        ...
        { name: '校友统计', desc: '校友统计', icon: 'el-icon-book', color: '#E6A23C', path: '/system/admission/chart' },
