...
export const constantRoutes = [
  ...
  //录取信息
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/system/student_admission/studentSearch"),
      ...
      },
       {
        ...
        meta: { title: "校友信息展板", requireAuth: true },
        hidden: true,
      },
    ],
  },
  //新闻
  {
    ...
    children: [
      ...
      {
        path: "list/:typeId",
        name: "noticeListByType",
        component: () => import("@/views/system/notice/noticeListByType"),
        meta: { title: "分类别列表", requireAuth: true },
        hidden: true,
      },
      {
        path: "list",
  ...
  // 论坛模块主路由（嵌套路由，统一管理论坛所有页面）
  {
    ...
    children: [
      ...
      // 2. 帖子审核（需登录权限）
      {
        path: "post/audit",
        name: "ForumPostAudit",
        component: () => import("@/views/system/forum_post/forumAdmin"), // 帖子发布组件路径
        meta: { title: "审核帖子", icon: "el-icon-plus", requireAuth: true }, // requireAuth：标记需登录
        hidden: false, // false：显示在侧边栏；true：隐藏（仅通过按钮跳转）
      },
    ],
  },
