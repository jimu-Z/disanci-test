  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="关键词审核" prop="keywordAudit">
        <el-input v-model="queryParams.keywordAudit" placeholder="请输入关键词审核" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="AI审核" prop="aiAudit">
        <el-input v-model="queryParams.aiAudit" placeholder="请输入AI审核" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="最终结果" prop="auditResult">
        <el-input v-model="queryParams.auditResult" placeholder="请输入最终结果" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:content_audit:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:content_audit:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:content_audit:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:content_audit:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核内容">
          <editor v-model="form.contentContent" :min-height="192" :editor-options="editorOptions" />
        </el-form-item>
        <el-form-item label="关键词审核" prop="keywordAudit">
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.form.contentContent = this.form.contentContent.replace(/data:image\/[^"']+/g, '') // 清除 base64
          // 过滤危险标签：script/iframe/onclick/javascript:void(0)
          this.form.contentContent = xss(this.form.contentContent, {
            whiteList: {
              p: [],
              br: [],
              span: ['style'],
