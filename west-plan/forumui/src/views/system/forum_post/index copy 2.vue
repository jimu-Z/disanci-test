  ...
  <div class="forum-container">
    ...
    <div class="forum-banner">
      <div class="banner-content">
        <h1 class="banner-title">校友论坛
           <span class="banner-desc">分享工作经验 · 交流生活心得 </span>
         </h1>
 <el-button
          type="primary"
          size="large"
    ...
    <div class="forum-main container">
      ...
      <div class="main-right">
        ...
        <div class="forum-card stat-card">
          ...
          <div class="stat-list">
            <div class="stat-item">
              <p class="stat-num">{{ statData.postTotal  }}</p>
              <p class="stat-name">总帖子</p>
            </div>
            <div class="stat-item">
              <p class="stat-num">{{ statData.boardTotal}}</p>
              <p class="stat-name">总板块</p>
            </div>
            <div class="stat-item">
              <p class="stat-num">{{ statData.commentTotal }}</p>
              <p class="stat-name">总评论</p>
            </div>
            <div class="stat-item">
              <p class="stat-num">{{ statData.userTotal }}</p>
    ...
    <el-card class="forum-card" shadow="hover">
      <div class="flex items-center justify-between mb-4">
        ...
        <el-button type="primary" icon="el-icon-plus" @click="toPostAdd"  >
          发布帖子
        </el-button>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      pageNum: 1,
      pageSize: 10,
      total: 0,// 侧边栏统计/标签/用户/公告（模拟数据，可替换为真实接口）
      statData: {
        postTotal: 1258,
        boardTotal: 16,
        commentTotal: 8965,
