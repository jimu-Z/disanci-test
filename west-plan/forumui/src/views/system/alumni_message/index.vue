  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="发送人ID" prop="sendUserId">
        <el-input v-model="queryParams.sendUserId" placeholder="请输入发送人ID" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="接收人ID" prop="receiveUserId">
        <el-input v-model="queryParams.receiveUserId" placeholder="请输入接收人ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="是否已读" prop="isRead">
        <el-input v-model="queryParams.isRead" placeholder="请输入是否已读" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="已读时间" prop="readTime">
        <el-date-picker clearable v-model="queryParams.readTime" type="date" value-format="yyyy-MM-dd"
          placeholder="请选择已读时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:alumni_message:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:alumni_message:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:alumni_message:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:alumni_message:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="私信内容">
          <editor v-model="form.msgContent" :min-height="192" :editor-options="editorOptions" />
        </el-form-item>
        <el-form-item label="是否已读" prop="isRead">
        ...
        <el-form-item label="已读时间" prop="readTime">
          <el-date-picker clearable v-model="form.readTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择已读时间">
          </el-date-picker>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.form.msgContent = this.form.msgContent.replace(/data:image\/[^"']+/g, '') // 清除 base64
          // 过滤危险标签：script/iframe/onclick/javascript:void(0)
          this.form.msgContent = xss(this.form.msgContent, {
            whiteList: {
              p: [],
              br: [],
              span: ['style'],
